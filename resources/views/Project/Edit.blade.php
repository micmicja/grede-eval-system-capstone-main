<x-layouts.app title="Edit Project">
    <div class="container-fluid py-4">
        <div class="row mb-4">
            <div class="col-md-8">
                <h2>Edit Project</h2>
                <p class="text-muted">Update project information for {{ $proj->full_name }}</p>
            </div>
        ...
        <div class="card shadow" style="max-width: 600px;">
            <div class="card-body p-5">
                <form method="POST" action="{{ route('project.update', $proj->id) }}">
                    @csrf
                    @method('PUT')

                    <div class="mb-3">
                        <label class="form-label fw-bold">Student Name</label>
                        <input type="text" class="form-control" value="{{ $proj->full_name }}" disabled>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="activity_title" 
                               name="activity_title"
                               value="{{ old('activity_title', $proj->activity_title) }}"
                               required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" 
                               ...
                               id="date_taken" 
                               name="date_taken"
                               value="{{ old('date_taken', $proj->date_taken) }}"
                               required>
                        @error('date_taken')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror

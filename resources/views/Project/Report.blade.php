<x-layouts.app :title="'Project Report - ' . $student->full_name">
    <div class="container-fluid py-4">
            ...
            <div class="col-md-3">
                <div class="card text-center shadow-sm">
                    <div class="card-body">
                        ...
                        <h2 class="text-primary">{{ $projectRecords->count() }}</h2>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card text-center shadow-sm">
                    <div class="card-body">
                        ...
                        <h2 class="text-success">{{ number_format($averageProjectScore, 1) }}/100</h2>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card text-center shadow-sm">
                    <div class="card-body">
                        ...
                        <h2 class="text-info">{{ $highestProjectScore }}/100</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow">
            <div class="card-header bg-light">
                <h5 class="mb-0">Project History</h5>
            </div>

<x-layouts.app title="Add Exam Scores">
    <div class="container-fluid py-4">
            ...
            <div class="col-md-4 text-end">
                <div class="btn-group me-2" role="group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('export.activity-results', ['type' => 'Exam', 'title' => $examName, 'date' => $dateTaken, 'format' => 'pdf']) }}"><i class="fas fa-file-pdf"></i> Export as PDF</a></li>
                        <li><a class="dropdown-item" href="{{ route('export.activity-results', ['type' => 'Exam', 'title' => $examName, 'date' => $dateTaken, 'format' => 'excel']) }}"><i class="fas fa-file-excel"></i> Export as Excel</a></li>
                        <li><a class="dropdown-item" href="{{ route('export.activity-results', ['type' => 'Exam', 'title' => $examName, 'date' => $dateTaken, 'format' => 'word']) }}"><i class="fas fa-file-word"></i> Export as Word</a></li>
                    </ul>
                </div>
                <a href="{{ route('exam.create-exam-page') }}" class="btn btn-outline-secondary">Back to Exam List</a>
            </div>
        </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-body bg-light">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form method="GET" action="{{ route('exam.add-scores') }}" class="d-flex align-items-center">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('exam.save-scores') }}">
                    @csrf
                    <input type="hidden" name="exam_name" value="{{ $examName }}">
                    <input type="hidden" name="date_taken" value="{{ $dateTaken }}">
                    <input type="hidden" name="total_items" value="{{ $totalItems }}">
                    ...
                    <div class="mt-4 d-flex justify-content-between align-items-center">
                        <div class="text-muted">
                            <small>
                                ...
                                Leave blank for students who didn't take the exam
                            </small>
                        </div>

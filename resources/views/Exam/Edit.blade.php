<x-layouts.app title="Edit Exam Score">
    <div class="container-fluid py-4">
        <div class="row mb-4">
            <div class="col-md-8">
                <h2>Edit Exam Score</h2>
                <p class="text-muted">Update exam information for {{ $exam->full_name }}</p>
            </div>
            ...
            <div class="card-body p-5">
                <form method="POST" action="{{ route('exam.update', $exam->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $exam->full_name }}" disabled>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="activity_title" 
                               name="activity_title"
                               value="{{ old('activity_title', $exam->activity_title) }}"
                               required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" 
                               ...
                               id="date_taken" 
                               name="date_taken"
                               value="{{ old('date_taken', $exam->date_taken) }}"
                               required>
                        @error('date_taken')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror

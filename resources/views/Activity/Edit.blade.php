<x-layouts.app title="Edit Activity">
    <div class="container-fluid py-4">
        <div class="row mb-4">
            <div class="col-md-8">
                <h2>Edit Activity</h2>
                <p class="text-muted">Update activity information for {{ $activity->full_name }}</p>
            </div>
            ...
            <div class="card-body p-5">
                <form method="POST" action="{{ route('activity.update', $activity->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $activity->full_name }}" disabled>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" 
                               ...
                               id="date_taken" 
                               name="date_taken"
                               value="{{ old('date_taken', $activity->date_taken) }}"
                               required>
                        @error('date_taken')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number"
                                   ...
                                   min="0"
                                   step="0.5"
                                   value="{{ old('score', $activity->score) }}"
                                   required>

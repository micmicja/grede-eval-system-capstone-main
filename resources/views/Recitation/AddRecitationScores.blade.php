<x-layouts.app title="Add Recitation Scores">
    <div class="container-fluid py-4">
            ...
            <div class="col-md-4 text-end">
                <div class="btn-group me-2" role="group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{ route('export.activity-results', ['type' => 'Recitation', 'title' => $recitationName, 'date' => $dateTaken, 'format' => 'word']) }}"><i class="fas fa-file-word"></i> Export as Word</a></li>
                    </ul>
                </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-body bg-light">
                <div class="row">
                    <div class="col-md-3">
                        <strong>Recitation Name:</strong> {{ $recitationName }}
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                        <form method="GET" action="{{ route('recitation.add-scores') }}" class="d-flex align-items-center">
                            <input type="hidden" name="recitation_name" value="{{ $recitationName }}">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('recitation.save-scores') }}">
                    @csrf
                    <input type="hidden" name="recitation_name" value="{{ $recitationName }}">
                    <input type="hidden" name="date_taken" value="{{ $dateTaken }}">
                    <input type="hidden" name="total_items" value="{{ $totalItems }}">
                    ...
                    <div class="mt-4 d-flex justify-content-between align-items-center">
                        <div class="text-muted">
                            <small>
                                ...
                                Leave blank for students who didn't participate in the recitation
                            </small>
                        </div>

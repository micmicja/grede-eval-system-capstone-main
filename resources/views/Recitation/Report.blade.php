<x-layouts.app :title="'Recitation Report - ' . $student->full_name">
    <div class="container-fluid py-4">
        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <div class="card text-center shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title">Total Recitations</h5>
                        <h2 class="text-primary">{{ $recitationRecords->count() }}</h2>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card text-center shadow-sm">
                    <div class="card-body">
                        ...
                        <h2 class="text-success">{{ number_format($averageRecitationScore, 1) }}/100</h2>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card text-center shadow-sm">
                    <div class="card-body">
                        ...
                        <h2 class="text-info">{{ $highestRecitationScore }}/100</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow">
            <div class="card-header bg-light">
                <h5 class="mb-0">Recitation History</h5>
            </div>
